...
public class TotemtasticItems {
    ...
    public static final Item WORMHOLE_TOTEM = registerItem("wormhole_totem", new Item(new FabricItemSettings().maxCount(1).rarity(Rarity.RARE)));
    public static final Item RECALL_TOTEM = registerItem("recall_totem", new Item(new FabricItemSettings().maxCount(1).rarity(Rarity.RARE)));
    //misc
