...
public class TotemtasticItems {
    ...
    public static final Item WORMHOLE_TOTEM = registerItem("wormhole_totem", new Item(new FabricItemSettings().maxCount(1)));
    public static final Item RECALL_TOTEM = registerItem("recall_totem", new Item(new FabricItemSettings().maxCount(1)));
    //misc
    public static final Item IRON_KNIFE = registerItem("iron_knife", new Item(new FabricItemSettings().maxCount(1)));
    public static final Item GLASS_VIAL = registerItem("glass_vial", new Item(new FabricItemSettings()));
    public static final Item BLOOD_VIAL = registerItem("blood_vial", new Item(new FabricItemSettings()));
