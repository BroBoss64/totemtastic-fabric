...
public class ResurrectionTotemItem extends Item {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        if (!context.getWorld().isClient()) {
            ...
            UUID targetUUID = TotemtasticItemUtils.fetchUUIDFromItemStack(context.getStack());
            PlayerEntity targetPlayer = TotemtasticItemUtils.getPlayerEntityFromUUID((ServerWorld) context.getWorld(), targetUUID);
            if (targetUUID == null) {
