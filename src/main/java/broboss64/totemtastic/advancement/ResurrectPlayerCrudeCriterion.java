...
public class ResurrectPlayerCrudeCriterion extends AbstractCriterion {
    public static final Identifier ID = new Identifier(Totemtastic.MOD_ID, "resurrect_player_crude");
